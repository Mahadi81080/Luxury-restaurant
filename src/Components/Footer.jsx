const Footer = () => {
  return (
    <div>
      <footer data-aos="fade-up" data-aos-duration='1000' className="px-4 divide-y bg-[#373844] text-white py-8">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            ...
            >
              <div className="flex items-center justify-center bg-white py-4 rounded-xl">
                <img
